...
[![Open T4 in Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/pdtd2503/Day22-2A202601978-PhamDanhTuanDung/blob/main/colab/Lab22_DPO_T4.ipynb)
...
```bash
git clone https://github.com/pdtd2503/Day22-2A202601978-PhamDanhTuanDung.git
cd Day22-2A202601978-PhamDanhTuanDung
...
1. **Fork hoặc copy repo này lên GitHub account của bạn**, set repo **public**.
   ```bash
   git init -b main
   git remote add origin https://github.com/pdtd2503/Day22-2A202601978-PhamDanhTuanDung.git
   ```
